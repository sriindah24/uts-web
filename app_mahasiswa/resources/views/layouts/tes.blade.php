                ...
                <li class="user-name"><span>Sri Indah</span></li>
                  <li class="dropdown avatar-dropdown">
                   ...
                   <ul class="dropdown-menu user-dropdown">
                     <li><a href="#"><span class="fa fa-box"></span> Barang</a></li>
                     <li><a href="#"><span class="fa fa-calendar"></span> Penjual</a></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a class="tree-toggle nav-header"><span class="fa-box"></span> Barang
                    ...
                    <span class="fa fa"></span>Penjualan
                    <span class="fa-angle-right fa right-arrow text-right"></span></a>
                    </li>          
                    <li class="ripple"><a class="tree-toggle nav-header">
